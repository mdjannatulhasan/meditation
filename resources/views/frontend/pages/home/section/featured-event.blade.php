        ...
        <div class="swiper-container swiper-container3">
            <div class="swiper-wrapper swiper-slide-pb">
                <div class="swiper-slide">
                    <div class="featured-events shadow-4 rounded-tt">
                        <div class="featured-events-img p-relative">
                            <img src="{{ asset('') }}asset/frontend/images/session1.png" alt="featured events"
                                class="img">
                ...
                <div class="swiper-slide">
                    <div class="featured-events shadow-4 rounded-tt">
                        <div class="featured-events-img p-relative">
                            <img src="{{ asset('') }}asset/frontend/images/featured-events2.png" alt="featured events"
                                class="img">
                ...
                <div class="swiper-slide">
                    <div class="featured-events shadow-4 rounded-tt">
                        <div class="featured-events-img p-relative">
                            <img src="{{ asset('') }}asset/frontend/images/featured-events3.png" alt="featured events"
                                class="img">
