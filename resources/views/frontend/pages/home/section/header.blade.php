...
<nav class="mobail-menu d-flex align-items-center justify-content-center d-md-none">
    <ul class="tc">
        <li><a href="#meditations"
                class="transition-e tc d-block ps-700 cff s18 capitalize active">Meditations</a></li>
        <li><a href="courses.html" class="transition-e tc d-block ps-700 cff s18 capitalize">Courses</a>
        </li>
        <li><a href="sessions.html" class="transition-e tc d-block ps-700 cff s18 capitalize">Sessions</a>
        </li>
        <li><a href="events.html" class="transition-e tc d-block ps-700 cff s18 capitalize">Events</a>
        </li>
        <li><a href="gallary.html" class="transition-e tc d-block ps-700 cff s18 capitalize">Gallary</a>
        </li>
    </ul>
</nav>
